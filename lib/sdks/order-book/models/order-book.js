export default class OrderBook {
  ...
  getAverageAskSafetyPrice = percentageOrder => percentageOrder * this.getAverageAskPrice();
  
  getEstimatorData = (percentageOrder = 1) => {
    return [
      {
        ...
        averageAskSafetyPrice: this.getAverageAskSafetyPrice(percentageOrder),
      },
    ];
  }
}
