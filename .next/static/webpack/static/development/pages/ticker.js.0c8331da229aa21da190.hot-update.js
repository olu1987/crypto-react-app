...
function getTickerList() {
  var functions = [get(_constants_currency_pairs__WEBPACK_IMPORTED_MODULE_3__["default"][0].value), get(_constants_currency_pairs__WEBPACK_IMPORTED_MODULE_3__["default"][1].value)];
  return pipe(functions); //return currencyPairsList.map(el => ({ name: el.name, data: get(el.value).then(data => data) }));
}
...
//# sourceMappingURL=ticker.js.0c8331da229aa21da190.hot-update.js.map